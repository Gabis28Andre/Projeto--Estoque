...
def adm_acesso(lista_comandos, arquivo_adms, arquivo_estoque):
    ...
    if len(adms) == 0:
        print('Ainda nao ha administradores cadastrados. E necessario cadastrar o primeiro administrador.')
        # Cadastrando
    ...
    while True:
        ...
        if comando == 1:  # Ver estoque
            ...
            if usuario_ativo == usuario_removido:
                print()
                print('O usuario ativo foi removido do cadastro. E necessaria nova autenticacao.')
                break
        elif comando == 0:  # Sair
            break
...
def cliente_acesso(lista_comandos, arquivo_com_estoque):
    ...
    if aux.checa_vazio(estoque):
        print('O estoque esta vazio. E necessario adicionar itens ao estoque primeiro.')
        return None
